...
int main(){
    ...
    rota melhora_rota  = movimento_em_unica_rota(&rotas[1],&grafo2);
    printf("\n%d",calcular_peso_rota(&grafo2,&rotas[1]));
...
rota movimento_em_multiplas_rotas(rota *rota_atual, grafo_solucao *grafo) {
    // Calcula o peso da rota atual
    int melhor_peso = calcular_peso_rota(grafo, rota_atual);
